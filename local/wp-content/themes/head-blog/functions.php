...
function head_blog_theme_stylesheets() {
	...
	// Theme stylesheet.
	wp_enqueue_style( 'head-blog-stylesheet', get_stylesheet_uri(), array('bootstrap'), '1.0.7'  );
...
function head_blog_theme_js() {
	...
	wp_enqueue_script( 'head-blog-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.0.7', true );
}
