...
*/
	...
	public function admin_menu ()
	{
		...
		add_menu_page($page_title, $menu_title, $admin_capability, $menu_slug, $function, $icon_url, 82);
		...
		if (Install::isPro())
		{
			...
			add_submenu_page($menu_slug, $page_title, $page_title, $admin_capability, $submenu_slug, $function);
		}
	}
